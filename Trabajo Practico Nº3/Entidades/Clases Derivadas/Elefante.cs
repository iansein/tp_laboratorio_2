...
namespace Entidades.Clases_Derivadas
{
    ...
    {   
        ...
        /// <param name="codigoDeIdentificacion"> Codigo de identificacion a asignarle al elefante. </param>
        /// <param name="tamanio"> Tamaño asignarle al elefante. </param>
        public Elefante(string nombre, EUbicacion ubicacion, int codigoDeIdentificacion, ETamanio tamanio) : base(nombre, ubicacion, codigoDeIdentificacion, tamanio)
        {
