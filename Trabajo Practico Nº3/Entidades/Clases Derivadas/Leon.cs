...
namespace Entidades
{
    ...
    {   
        ...
        /// <param name="codigoDeIdentificacion"> Codigo de identificacion a asignarle al leon. </param>
        /// <param name="tamanio"> Tamaño asignarle al leon. </param>
        public Leon(string nombre, EUbicacion ubicacion, int codigoDeIdentificacion, ETamanio tamanio) : base(nombre, ubicacion, codigoDeIdentificacion, tamanio)
        {
