...
namespace Entidades.Clases_Derivadas
{
    public class Delfin : Mamifero
    {
        ...
        /// <param name="id"> Codigo de identificacion a asignarle al delfin. </param>
        /// <param name="tamanio"> Tamaño asignarle al delfin. </param>
        public Delfin(string nombre, EUbicacion ubicacion, int id, ETamanio tamanio) : base(nombre, ubicacion, id, tamanio)
        {
