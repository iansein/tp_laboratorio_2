...
namespace Entidades.Clases_Derivadas
{
    ...
    {   
        ...
        /// <param name="id"> Codigo de identificacion a asignarle al hipopotamo. </param>
        /// <param name="tamanio"> Tamaño asignarle al hipopotamo. </param>
        public Hipopotamo(string nombre, EUbicacion ubicacion, int id, ETamanio tamanio) : base(nombre, ubicacion, id, tamanio)
        {
