    ...
    public partial class FrmAlta : Form
    {
        ...
        private void btn_Agregar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (ValidarNombre(txtBox_Nombre.Text) == false || String.IsNullOrWhiteSpace(txtBox_Nombre.Text))
                {
                ...
                if (!Int32.TryParse(txtBox_CodigoIdentificacion.Text, out id))
                {
                    IdException codigoEx = new IdException();
                    throw codigoEx;
                }
                ...
                switch (cmb_Mamifero.Text)
                {
                    ...
                    case "Leon":
                        this.leon = new Leon(txtBox_Nombre.Text, ubicacion, id, tamanio);
                        ...
                        MamiferosAcessoDatos.Agregar(this.leon);


                        break;

                    case "Elefante":
                        this.elefante = new Elefante(txtBox_Nombre.Text, ubicacion, id, tamanio);
                        ...
                        MamiferosAcessoDatos.Agregar(this.elefante);

                        break;

                    case "Hipopotamo":
                        this.hipopotamo = new Hipopotamo(txtBox_Nombre.Text, ubicacion, id, tamanio);
                        ...
                        MamiferosAcessoDatos.Agregar(this.hipopotamo);

                        break;

                    case "Delfin":
                        this.delfin = new Delfin(txtBox_Nombre.Text, ubicacion, id, tamanio);
                        ...
                        MamiferosAcessoDatos.Agregar(this.delfin);
